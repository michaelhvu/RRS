...
executable: controller.o robot_model.o robot_part.o robot_head.o robot_locomotor.o robot_torso.o robot_arm.o robot_battery.o view.o order.o customer.o
	$(CXX) $(CXXFLAGS) controller.o robot_model.o robot_part.o robot_head.o view.o order.o customer.o
